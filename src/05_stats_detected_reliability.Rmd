...
We will utilize our "full" model presented in the [prior section](#f_5_pred_mod_bays) in which we modeled the F-score which is a measure of how well the UAS detected trees represent the field survey trees. But here we will change the likelihood function and the prior distributions.

For a more in-depth review of the traditional treatment of this sort of data structure called multifactor analysis of variance (ANOVA) compared to the Bayesian hierarchical generalization of the traditional ANOVA model used here see [this previous section](#stats_validation).
