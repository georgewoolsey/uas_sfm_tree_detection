...
join the SfM data generation to the processing data which we'll use to build our full analysis data set and create the normalized processing time using Min-Max normalization as:
